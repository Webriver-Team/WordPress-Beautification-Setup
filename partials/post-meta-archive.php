...
$basethemevar_user_profile_image = get_field( 'basethemevar_user_profile_image', 'user_' . $p_id );
if ( $basethemevar_user_profile_image ) {
	$basethemevar_author_image = $basethemevar_user_profile_image;
} elseif ( ( get_avatar_url( get_the_author_meta( 'ID' ) ) ) != 'http://0.gravatar.com/avatar/?s=96&d=mm&r=g' || ( get_avatar_url( get_the_author_meta( 'ID' ) ) ) != 'http://1.gravatar.com/avatar/?s=96&d=mm&r=g' || ( get_avatar_url( get_the_author_meta( 'ID' ) ) ) != 'http://2.gravatar.com/avatar/?s=96&d=mm&r=g' ) {
