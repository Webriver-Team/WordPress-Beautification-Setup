...
const postcss = require('gulp-postcss'); // Gulp plugin for postcss processes.
const autoprefixer = require('autoprefixer');
const minifycss = require('gulp-uglifycss'); // Minifies CSS files.
const gulp_autoprefixer = require('gulp-autoprefixer'); // Autoprefixing magic.
...
gulp.task('styles', () => {
	var plugins = [
		autoprefixer({
			'overrideBrowserslist': config.BROWSERS_LIST_AUTOPREFIXER
		})
	];
